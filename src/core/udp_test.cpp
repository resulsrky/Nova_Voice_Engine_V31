// src/core/udp_test.cpp - Basit UDP Test
#include <iostream>
...
public:
    UDPTest(const std::string& local_ip, uint16_t local_port, 
        ...
        std::cout << "UDP Test initialized:" << std::endl;
...
int main() {
    try {
        const std::string local_ip = "192.168.1.254";
        const uint16_t local_port = 50000;
        const std::string remote_ip = "192.168.1.5";
        const uint16_t remote_port = 50001;
